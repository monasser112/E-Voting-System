    ...
    const checkCorrectOTP=(val)=>{
     ...
     if(state.isOTPCorrect===2){
        ...
        <View style={{marginVertical:20,flexDirection:'row',justifyContent:'flex-start'}}>
          ...
          <Text style={{fontSize:24,marginLeft:10,color:'red',fontWeight:'bold'}}>Wrong!</Text>
        </View>
     </View>
     }
